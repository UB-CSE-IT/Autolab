...
ActiveRecord::Schema.define(version: 2023_09_20_164407) do
  ...
  create_table "ub_course_sections", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "course_id"
    t.string "name"
