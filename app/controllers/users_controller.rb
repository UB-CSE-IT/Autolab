class UsersController < ApplicationController
  ...
  def update
    ...
    if user.update(if current_user.administrator?
      ...
      flash[:error] = "Failed to update user. Check all fields and try again. First name and last name must be fewer than 32 characters. Combined, they must be at least one character."
